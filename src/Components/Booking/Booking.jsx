...
const RoomBooking = () => {
  ...
  const rooms = [
    ...
    { id: 2, name: "Twin Room", price: "$190/night" },
    { id: 3, name: "Quad Room", price: "$150/night" },
    { id: 4, name: "Deluxe Room", price: "$180/night" },
    { id: 5, name: "Exclusive Room", price: "$220/night" },
    {id: 6, name: "Personal Room", price: "$200/night" },
  ];
